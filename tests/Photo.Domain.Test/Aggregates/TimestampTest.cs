namespace EagleEye.Photo.Domain.Test.Aggregates
{
    ...
    public class TimestampTest
    {
        ...
        [InlineData(2001, 2, 29)] // 2000 is leap year
        [InlineData(2000, 6, 6, -1)]
        [InlineData(2000, 6, 6, 24)]
        [InlineData(2000, 6, 6, 200)]
        [InlineData(2000, 6, 6, 12, -1)]
        [InlineData(2000, 6, 6, 12, 60)]
        [InlineData(2000, 6, 6, 12, 30, -1)]
        [InlineData(2000, 6, 6, 12, 30, 60)]
